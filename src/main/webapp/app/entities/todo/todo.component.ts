...
export class TodoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.todoService
      ...
      .subscribe(
        (res: HttpResponse<ITodo[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInTodos(): void {
    this.eventSubscriber = this.eventManager.subscribe('todoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITodo[] | null, headers: HttpHeaders, page: number): void {
